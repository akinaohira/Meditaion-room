  ...
  <div className="container">
    <div className="manContainer">
      <svg
        ...
        />
        <path
          d="M512.916 336.955C511.202 341.051 505.397 341.047 503.689 336.949L488.686 300.959C487.312 297.664 489.734 294.033 493.304 294.035L523.361 294.056C526.931 294.059 529.348 297.694 527.97 300.987L512.916 336.955Z"
          fill="#4592D1"
        />
        <path
          d="M511.857 295.235C521.45 301.61 540.705 298.902 574.722 299.418C621.21 293.59 545.23 272.5 554 272.5"
          stroke="#4592D1"
          strokeWidth="19"
        />
        <rect
        ...
        <rect
          ...
          height="12.1671"
          rx="3"
          transform="rotate(-66.386 550.491 282.253)"
          fill="#73B5EC"
        />
        <rect
          x="369.891"
        ...
        <rect
          ...
          height="7.53273"
          rx="1"
          transform="matrix(0.000600427 1 -0.999994 0.00339957 372.491 317.16)"
          fill="#4592D1"
        />
        <ellipse
          rx="11.1031"
          ry="3.76814"
          transform="matrix(0.000600427 1 -0.999994 0.00339957 368.733 318.958)"
          fill="#4592D1"
        />
        <path
        ...
        />
        <path
          d="M443.615 313.323C442.298 315.54 437.512 318.804 430.028 318.804C422.544 318.804 417.018 316.587 415.934 314.967"
          stroke="#E7E7E7"
          strokeWidth="4"
          strokeLinecap="round"
        />
        ...
        />
        <path
          d="M443.615 321.394C442.298 323.611 437.512 326.875 430.028 326.875C422.544 326.875 417.018 324.658 415.934 323.038"
          stroke="#E7E7E7"
          strokeWidth="4"
          strokeLinecap="round"
        />
        <path
          d="M443.615 321.394C445.259 318.927 449.76 316.119 457.318 316.187C464.876 316.255 470.199 321.668 472.118 322.764"
          stroke="#E7E7E7"
          strokeWidth="4"
          strokeLinecap="round"
        />
        ...
        />
        <path
          d="M253.041 317.635C261.273 308.452 313.939 311.956 318 301.5C320.954 293.896 307 283 293.5 276"
          stroke="#F6C471"
          strokeWidth="14"
          strokeLinecap="round"
        />
        ...
        />
        <path
          d="M218.142 256.707C220.403 255.121 223.521 255.667 225.107 257.927L228.128 262.231C229.714 264.492 229.168 267.61 226.907 269.196L204.677 284.797C202.417 286.383 199.299 285.837 197.712 283.577L194.692 279.273C193.105 277.012 193.652 273.894 195.912 272.308L218.142 256.707Z"
          fill="#8ED1CD"
        />
        <rect
          x="271.381"
          ...
          height="37.1582"
          rx="5"
          transform="rotate(-57.3443 271.381 270.798)"
          fill="#8ED1CD"
        />
        <rect
          x="168.499"
    ...
    <p className="tittle"> {React.string("Discover your mindfulness.")} </p>
